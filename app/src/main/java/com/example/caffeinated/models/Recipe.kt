...
data class Recipe(
    ...
    var rating: Rating = Rating.newUnratedRating(Rating.RATING_5_STARS),
...
fun getRecipes(): List<Recipe> {
    return listOf(
        Recipe(
            ...
            rating = Rating.newStarRating(Rating.RATING_5_STARS,1.0F),
        ...
        Recipe(
            ...
            rating = Rating.newStarRating(Rating.RATING_5_STARS,0.0F),
